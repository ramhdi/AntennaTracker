...
void loop()
{
  ...
  else if (pan_val_last >= 1095 && pan_val_last < 1475)
  {
    ...
    //pan_speed = map(pan_val_last, 1474, 1095, 20, pan_speed_lim);
    pan.move(DIR_CW, pan_speed_lim);
  ...
  else if (pan_val_last > 1525 && pan_val_last <= 1905)
  {
    ...
    //pan_speed = map(pan_val_last, 1526, 1905, 20, pan_speed_lim);
    pan.move(DIR_CCW, pan_speed_lim);
